...
@login_required
@permission_required('camping.view_persona', raise_exception=True)
...
## CREATE
@login_required
@permission_required('camping.add_persona', raise_exception=True)
...
## UPDATE
@login_required
@permission_required('camping.change_persona', raise_exception=True)
...
## DELETE
@login_required
@permission_required('camping.delete_persona', raise_exception=True)
...
@login_required
@permission_required('camping.view_recepcionista', raise_exception=True)
...
## CREATE
@login_required
@permission_required('camping.add_recepcionista', raise_exception=True)
...
## UPDATE
@login_required
@permission_required('camping.change_recepcionista', raise_exception=True)
...
## DELETE
@login_required
@permission_required('camping.delete_recepcionista', raise_exception=True)
...
@login_required
@permission_required('camping.view_camping', raise_exception=True)
...
## CREATE
@login_required
@permission_required('camping.add_camping', raise_exception=True)
...
## UPDATE
@login_required
@permission_required('camping.change_camping', raise_exception=True)
...
## DELETE
@login_required
@permission_required('camping.delete_camping', raise_exception=True)
...
@login_required
@permission_required('camping.view_parcela', raise_exception=True)
...
## CREATE
@login_required
@permission_required('camping.add_parcela', raise_exception=True)
...
## UPDATE
@login_required
@permission_required('camping.change_parcela', raise_exception=True)
...
## DELETE
@login_required
@permission_required('camping.delete_parcela', raise_exception=True)
